import { addIngredientToConstructor, burgerConstructorSliceReducer, downPositionOfIngredient, initialState, removeIngredientFromConstructor, upPositionOfIngredient } from "../constructorSlice";
...
describe('Тестирование экшенов на добавление продуктов в конструктор бургера', () => {
